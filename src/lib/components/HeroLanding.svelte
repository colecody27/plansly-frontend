...
<section class="section-spacing px-6 lg:px-16">
  <div class="grid gap-12 lg:grid-cols-[1.1fr,0.9fr] items-center">
    <div class="space-y-6 fade-in-up">
      <p class="text-sm uppercase tracking-[0.2em] text-primary">Plan it. Share it. Split it.</p>
      ...
      <div class="flex flex-wrap gap-3 text-sm text-base-content/70">
        ...
        <span class="badge badge-outline">House parties</span>
        <span class="badge badge-outline">Group buys</span>
        <span class="badge badge-outline">Weekend adventures</span>
      </div>
    </div>
